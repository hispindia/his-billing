...
(function ($) {
  ...
  function getHead() {
    ...
    $(document)
      ...
      .filter(function () {
        // this filter contributed by "mindinquiring"
  ...
  function Iframe() {
    ...
    var iframeStyle =
      "border:0;position:absolute;width:0px;height:0px;left:0px;top:0px;";
    var iframe;
