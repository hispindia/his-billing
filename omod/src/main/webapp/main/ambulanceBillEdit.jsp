...
<script type="text/javascript">
	...
	function voidBill(){
		...
		<div id="billDiv">
		<form method="POST" id="billForm" action="editAmbulanceBill.form" onsubmit="return false">
		...
		<input type="hidden" name="ambulanceBillId" value="${ambulanceBill.ambulanceBillId}">  
