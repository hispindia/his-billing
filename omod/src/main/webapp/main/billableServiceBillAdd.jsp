	...
	function addToBill( conceptId, serviceName, servicePrice, qty) {
		...
		function submitBillForm(){
			...
			if( !ok ) {
				...
				else if( isNaN(jQuery("#waiverAmount").val()) || jQuery("#waiverAmount").val() < 0){
					alert("Please enter correct Waiver Amount");
					return false;
				}
...
<!-- 			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Payment Mode:</b>
		...
		<div id="extra" class="cancelDraggable"
			style="background: #f6f6f6; border: 1px #808080 solid; padding: 0.3em; margin: 0.3em 0em; width: 100%;">
			<input type='text' size='25' value='Service Name' readonly='readonly' style="border:none; outline:none; font-weight:bold; font-size:15px"/>&nbsp;
			<input type='text' size="3" value='Qty' readonly="readonly" style="border:none; outline:none; font-weight:bold; font-size:15px"/>&nbsp;
			<input type='text' size='5' value='Price' readonly="readonly" style="border:none; outline:none; font-weight:bold; font-size:15px"/>&nbsp;</b>
			<hr />
		</div>
